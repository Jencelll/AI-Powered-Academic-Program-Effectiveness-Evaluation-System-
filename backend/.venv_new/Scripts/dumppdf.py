#!D:\THESIS FINAL\AI-Powered Academic Program Effectiveness Evaluation System with an Integrated Recommendation Engine for BSIT and BSCS Programs\ai-cqi-web-system\backend\.venv_new\Scripts\python.exe
